            ...
            <div class="col-md-6 mx-auto" style="background-image: url(fundoLogin.jpg);">
                <div id="first">
                    <div class="myform form ">
                        ...
                        <a href="visualizaCliente.php" class="btn btn-secondary btn-lg btn-block">Visualizar Clientes</a>
                        
                        <a href="visualizaPedido.php" class="btn btn-secondary btn-lg btn-block">Visualizar Pedidos</a>
