...
<body style="background-image: url(fundoLogin.jpg);">
    ...
    <div class="col-md-12 text-center">
        <h1><b>Pedidos Realizados:</b></h1>
    </div><br>

    <form action="visualizaPedido.php" method="POST" class="form-inline mr-auto">
        <input class="form-control" name="filtro" type="text" placeholder="Digite o email do cliente..." aria-label="Search">
    ...
    if (isset($_POST['filtro'])) {
        $filtro = $_POST['filtro'];
        $sql = "SELECT * FROM pedido WHERE usuario LIKE '%$filtro%'";
    } else {
